    ...
    <div className="min-h-screen">
      ...
      <div className="max-w-md mx-auto px-6 py-16">
        ...
        <div className="w-20 h-20 mx-auto mb-8 rounded-full border-2 border-gold/30 flex items-center justify-center">
          <div className="w-14 h-14 rounded-full border border-gold/50"></div>
        </div>
        ...
        <div className="space-y-4 mb-8">
          <button
            ...
            disabled={loading}
            className="w-full glass-light rounded-lg p-4 flex items-center justify-center gap-3 hover:border-gold transition-all disabled:opacity-50"
          >
            ...
            <span className="text-cream font-semibold">Continue with Google</span>
          </button>
          ...
          >
            ...
            <span className="text-cream font-semibold">Continue with Apple</span>
          </button>
        </div>
        ...
        <form onSubmit={handleEmailLogin} className="space-y-6">
          ...
          <div>
            <label htmlFor="password" className="block text-cream/90 mb-2 font-medium">
              Password
            </label>
            <input
              type="password"
        ...
        <div className="text-center mt-4">
          <Link href="/forgot-password" className="text-cream/50 hover:text-gold text-sm transition-colors">
